...
CREATE TABLE "Users" (
    ...
    "gender" TEXT,
    "email" TEXT NOT NULL,
    "job_title" TEXT NOT NULL DEFAULT 'unemployed',
    "admin" BOOLEAN NOT NULL,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "Users_job_title_fkey" FOREIGN KEY ("job_title") REFERENCES "Job_title" ("name") ON DELETE RESTRICT ON UPDATE CASCADE
);
